...
${nuget_cmd} install src/AdventureWorksLT.Service/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/AdventureWorksLT.Service.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/AdventureWorksLT.Service.dll \
-recurse:'src/AdventureWorksLT.Service/*.cs' \
-doc:bin/AdventureWorksLT.Service.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/AdventureWorksLT.Service.dll was created successfully"
fi
